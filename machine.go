...
func GetBlobBytes(ctx context.Context, s schema.RO, x Ref, maxSize int) ([]byte, error) {
	return defaultOp.GetBlobBytes(ctx, s, x, maxSize)
}

func PostTree(ctx context.Context, s schema.WO, ents iter.Seq[TreeEntry]) (*Ref, error) {
	return defaultOp.PostTree(ctx, s, ents)
}

func PostTreeSlice(ctx context.Context, s schema.WO, ents []TreeEntry) (*Ref, error) {
	return defaultOp.PostTreeSlice(ctx, s, ents)
}

func PostTreeMap(ctx context.Context, s schema.WO, m map[string]Ref) (*Ref, error) {
...
func GetTreeSlice(ctx context.Context, store schema.RO, ref Ref, maxEnts int) ([]TreeEntry, error) {
...
func GetAtPath(ctx context.Context, store schema.RO, ref Ref, subpath string) (*Ref, error) {
...
func WalkTree(ctx context.Context, store schema.RO, ref Ref, f WalkTreeFunc) error {
...
func WalkRefs(ctx context.Context, s schema.RO, ref Ref, fn RefWalker) error {
...
func Sync(ctx context.Context, dst schema.WO, src schema.RO, x Ref) error {
...
func FilterPaths(ctx context.Context, dst schema.WO, src schema.RO, root Ref, f func(string) bool) (*Ref, error) {
	return defaultOp.FilterPaths(ctx, dst, src, root, f)
}

// ShardLeaves calls ShardLeaves on the default Machine
func ShardLeaves(ctx context.Context, dst schema.WO, s schema.RO, root Ref, n int) ([]Ref, error) {
	return defaultOp.ShardLeaves(ctx, dst, s, root, n)
}

// MapBlobs calls MapBlobs on the default Machine
func MapBlobs(ctx context.Context, dst schema.WO, src schema.RO, root Ref, f BlobMapper) (*Ref, error) {
	return defaultOp.MapBlobs(ctx, dst, src, root, f)
}

// MapLeaves calls MapLeaves on the default Machine
func MapLeaves(ctx context.Context, dst schema.WO, src schema.RO, root Ref, f RefMapper) (*Ref, error) {
	return defaultOp.MapLeaves(ctx, dst, src, root, f)
}

// MapEntryAt calls MapEntryAt on the default Machine
func MapEntryAt(ctx context.Context, dst schema.WO, src schema.RO, root Ref, p string, f TreeEntryMapper) (*Ref, error) {
