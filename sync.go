...
func (ag *Machine) Sync(ctx context.Context, dst schema.WO, src schema.RO, x Ref) error {
	switch x.Type {
	case TypeBlob:
...
func (ag *Machine) syncTreeEntries(ctx context.Context, dst schema.WO, src schema.RO, ents []TreeEntry) error {
